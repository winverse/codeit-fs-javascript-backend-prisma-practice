...
| Prisma 프로젝트 준비(선택) | `src/practices/05-prisma-project-setup`   | `npm run check:05` |
| 환경 변수 검증(선택)       | `src/practices/06-project-config`         | `npm run check:06` |
