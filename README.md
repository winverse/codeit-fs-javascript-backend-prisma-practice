...
`관계형 데이터베이스를 활용한 자바스크립트 서버 만들기` 과정의 독립 문제 해결 실습입니다. SQL과 ER 모델링 4개, Prisma 활용 11개를 각각 별도 시작 상태에서 연습합니다.
...
마지막 `npm test`가 15개 문제의 미완성 조건을 보여 주며 실패하면 정상입니다.

Node.js 26.7.0 이상 27 미만과 npm 11을 사용합니다.
...
| Prisma 프로젝트 준비        | `src/practices/05-prisma-project-setup`   | `npm run check:05` |
| 프로젝트 설정               | `src/practices/06-project-config`         | `npm run check:06` |
